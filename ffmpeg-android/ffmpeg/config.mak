...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --cross-prefix=arm-linux-androideabi- --arch=arm --sysroot=/Developer/android-ndk-r5b//platforms/android-3/arch-arm --soname-prefix=/data/data/com.mobvcasting.mjpegffmpeg/ --enable-shared --disable-symver --enable-small --optimization-flags=-O2 --enable-encoder=mpeg2video --enable-encoder=nellymoser --enable-protocol=file --prefix=../build/ffmpeg/armeabi-v7a --extra-cflags='-march=armv7-a -mfloat-abi=softfp' --extra-ldflags=
...
SONAME_PREFIX=/data/data/com.mobvcasting.mjpegffmpeg/
SRC_PATH="/Users/vanevery/Desktop/Work/Witness/ffmpeg-android/ffmpeg"
SRC_PATH_BARE=/Users/vanevery/Desktop/Work/Witness/ffmpeg-android/ffmpeg
BUILD_ROOT="/Users/vanevery/Desktop/Work/Witness/ffmpeg-android/ffmpeg"
...
CPPFLAGS= --sysroot=/Developer/android-ndk-r5b//platforms/android-3/arch-arm -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
